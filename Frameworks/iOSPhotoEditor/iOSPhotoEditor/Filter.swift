...
public struct Filter {
    ...
    public typealias Applier = ((_ image: CIImage) -> CIImage?)
    ...
    public init(name: String, coreImageFilterName: String) {
        self.name = name
        self.applier = Self.coreImageFilter(name: coreImageFilterName)
    }

    public init(name: String, applier: Applier?) {
        self.name = name
...
extension Filter {
    ...
    public static func coreImageFilter(name: String) -> Filter.Applier {
