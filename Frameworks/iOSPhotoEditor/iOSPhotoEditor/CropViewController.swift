...
open class CropViewController: UIViewController {
    ...
    open override func viewDidLoad() {
        ...
        if self.toolbarItems == nil {
            ...
            let constrainButton = UIBarButtonItem(
                image: ToolBarButtonImageBuilder.clampImage(),
                style: .plain,
                target: self,
            ...
            let flipButton = UIBarButtonItem(
                image: UIImage(systemName: "flip.horizontal"),
                style: .plain,
                target: self,
                action: #selector(onFlipBarButtonItemTap(_:))
            )

            toolbarItems = [flexibleSpace, constrainButton, flipButton, flexibleSpace]
        }
    ...
    @objc func constrain(_ sender: UIBarButtonItem) {
        ...
        let original = UIAlertAction(title: "Оригинал", style: .default) { [unowned self] action in
        ...
        let square = UIAlertAction(title: "Квадрта", style: .default) { [unowned self] action in
...
//            self.cropView?.cropAspectRatio = ratio
    ...
    @objc private func onFlipBarButtonItemTap(_ sender: UIBarButtonItem) {
        image = image?.flippedRightLeft
    }
}
